...
let theButtons = document.querySelectorAll("#buttonHolder img", "#resetBut button"),
...
function changeBGImage() {
	...
	if (document.querySelector(".puzzle-board").children.length > 0) {
...
resetBut.addEventListener("click", resetPuzzle);
